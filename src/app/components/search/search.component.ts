...
import { MetaDataList } from 'src/app/models/meta-data.model';
...
export class SearchComponent {
  ...
  constructor(private _FB: FormBuilder, private http: HttpClient, private service: AppService, private api : ApiService, private auth: AuthService, private userStore: UserStoreService) {
